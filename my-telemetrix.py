...
class ControlSystem:
    def __init__(self):
        ...
        self.drive_left, self.drive_right = Motor12x5ALite(3,2, self.board), Motor12x5ALite(4,5, self.board)
    ...
    def drivetrain(self):
        ...
        self.drive_left.power( int( self.gamepad.keys["ABS_Y"] - 256 ))
        self.drive_right.power(int( self.gamepad.keys["ABS_RZ"] - 256 ))
        print(equation)
